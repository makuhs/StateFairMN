...
plot<- ggplot(recordCurrent, aes(numberDay, attendance))+
  ...
  annotate("text", x = 6, y = 370000, label = "MINNESOTA STATE FAIR DAILY ATTENDANCE",
           ...
           size = 8,
           color = "grey20")+
  annotate("text", x = 6, y = 352000, label = subtitle,
           hjust = 0.5,
           family = "Open Sans",
           size = 4,
           color = "grey30")+
  annotate("text", x = 6, y = 325000, label = subsubtitle,
           hjust = 0.5,
           family = "Open Sans",
           size = 3,
           color = "grey50")+
